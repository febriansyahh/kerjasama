						...
						<tbody>
							...
							<tr>
                                ...
                                <a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#editStatus"
                                    onclick="editableStatus(this)"
                                    data-id="<?php echo $value->id_status . "~" . $value->nama_status ?>"
                                    class="btn btn-success btn-sm"><i class="fas fa-edit"></i> Edit</a>
                                <a onclick="deleteConfirm('<?php echo site_url('admin/status_ajuan/delete/' . $value->id_status) ?>')"
