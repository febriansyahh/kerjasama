<div class="container"><a class="navbar-brand" href="<?php echo base_url() ?>"><img src="assets/img/logo-kerjasama.png" height="35" alt="logo" /></a>
  ...
  <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
    ...
    <div class="d-flex ms-lg-4"><a class="btn btn-secondary-outline" href="<?php echo base_url('login') ?>">Login</a></div>
  </div>
</div>