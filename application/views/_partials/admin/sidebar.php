<nav class="navbar navbar-dark navbar-theme-primary px-4 col-12 d-lg-none">
	<a class="navbar-brand me-lg-5" href="<?php echo site_url('admin/overview') ?>">
		<img class="navbar-brand-dark" src="<?php echo base_url('assets/img/umk.png'); ?>" alt="Volt logo" /> <img
...
<nav id="sidebarMenu" class="sidebar d-lg-block bg-gray-800 text-white collapse" data-simplebar>
		...
		<div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
			<div class="d-flex align-items-center">
				<div class="avatar-lg me-4">
					<img src="<?php echo base_url('assets_admin/img/icon.png') ?>"
						class="card-img-top rounded-circle border-white" alt="Bayu Sukma">
				</div>
				<div class="d-block">
	...
	<li class="nav-item ">
		<a href="<?php echo site_url('admin/history') ?>" class="nav-link">
			<span class="sidebar-icon">
